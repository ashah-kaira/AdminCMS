...
<head>
    ...
    <link href="<?php echo asset('/assets/global/css/components-md.min.css');?>" rel="stylesheet" type='text/css'>
...
<script src="<?php echo asset('/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js');?>"></script>
<script src="<?php echo asset('/assets/js/pagerjs/msgbox/msgGrowl.js');?>"></script>
<!-- END CORE PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="<?php echo asset('/assets/global/scripts/app.min.js');?>"></script>
